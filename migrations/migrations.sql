...
do $$
  ...
  -- Adds foreign key relationships for jobCoverageReports
    ...
    if exists (select 1 from information_schema.columns where table_name = 'runtimeTemplates') then
      ...
      --------------------------------------------------------
      update "runtimeTemplates" set "isDefault" = false where "version" != 'v6.8.4' and "isDefault" = true;
      update "runtimeTemplates" set "isDefault" = true where "version" = 'v6.8.4' and "isDefault" = false;
