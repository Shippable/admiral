...
function systemIntegrationRoutes(app) {
  ...
  app.post('/api/systemIntegrations/:systemIntegrationId/validate',
    validateAccount, require('./validateSysIntBaseUrl.js'));
  ...
  app.put('/api/systemIntegrations/:systemIntegrationId', validateAccount,
    require('./put.js'));
  app.delete('/api/systemIntegrations/:systemIntegrationId',
    validateAccount, require('./deleteById.js'));
}
