...
function getStatus(params, callback) {
  var bag = {
    ...
    gitlabUrl: params.systemIntegration.data.url,
    gitlabSSHPort: params.systemIntegration.data.sshPort,
    gitlabUsername: params.systemIntegration.data.username,
    gitlabPassword: params.systemIntegration.data.password,
    gitlabAdapter: null
  };
