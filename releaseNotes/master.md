...
- **Fixes alignment of flags dropdown menu**: Flags dropdown menu is always partially obstructed which was never allowing to see full flag name. This is now fixed.
