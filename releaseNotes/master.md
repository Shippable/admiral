...
## Features
  ...
  - **Ability to re-initialize the node in nodepool list page**: Now user can re-initialize the node in nodepool list page instead of going to particular node to re-initialize it.
