...
## Features
  ...
  - **shipctl get_git_changes**: shipctl includes a new command called `get_git_changes` [See the docs](http://docs.shippable.com/platform/tutorial/workflow/using-shipctl/#get_git_changes).
