...
- **Multiple authencation methods for enterprise SCMs**: Now server users can configure multiple authencations for different Gitlab, Bitbucket Server and GitHub Enterprise setups.

## Fixes
  - **Update p- **Multiple authencation methods for enterprise SCMs**: Now server users can setup multiple authencations for Gitlab, Bitbucket Server and GitHub Enterprise.rivate job count correctly**: Private job count gets reset to 0 every month for private projects with free subscriptions.
