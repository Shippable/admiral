...
## Features
  ...
  - **Ability to create subscription owned integrations**: Subscription users can now create shared subscription integrations, which allows you to restrict the usage of integration to members, collaborators and admin based on your requirement. Customers using BYON should upgrade their nodes and customers using caching with on-demand nodes should stop all their nodes.  ([support#4128](https://github.com/Shippable/support/issues/4128))
